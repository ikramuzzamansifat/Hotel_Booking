# Generated by Django 3.2 on 2021-12-14 03:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sust.hotels')),
            ],
        ),
        migrations.CreateModel(
            name='Reservation',
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sust.rooms')),
            ],
        ),
    ]
